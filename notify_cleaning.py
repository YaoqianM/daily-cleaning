...
WEBHOOKS = [
    "https://open.feishu.cn/open-apis/bot/v2/hook/b301c1ec-f7a7-4856-86ee-a42b99bbea3a",
    "https://open.feishu.cn/open-apis/bot/v2/hook/46ad6e59-7dab-4720-9ffe-3469b211fdfa",
]
...
def build_text(today: datetime) -> tuple[str, str, str]:
...
def send(webhook: str, text: str) -> None:
    ...
    with urllib.request.urlopen(req, timeout=10) as resp:
        print(f"[OK] → {webhook[-8:]} 飞书响应: {resp.read().decode()}")


def main() -> None:
    today = get_today()
    date_str, team, text = build_text(today)
